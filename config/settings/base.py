...
DATABASES = {
    ...
    "default": env.db(
        "DATABASE_URL", default="postgres:///spybook"
    )
}
...
MIGRATION_MODULES = {
    "sites": "spybook.contrib.sites.migrations"
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "spybook.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("Daniel Feldroy", "daniel-feldroy@example.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "spybook.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = (
    "spybook.users.adapters.SocialAccountAdapter"
)
